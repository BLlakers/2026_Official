 ...
 * Note that we're using this custom Record rather that depending on com.pathplanner.lib.config.PICConstants to avoid that
 * dependency throughout our config system
